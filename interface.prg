...
FUNC POPULATE_ARRAYS(TABLE_NAME)
   ...
   XSPECVAR(1,3) = GET_FIELD_VAL(TABLE_NAME, 'COD', XSPECVAR(1,3)) && C.O.D - .T. = COD / .F. = NO COD
   XSPECCHG(1,2) = GET_FIELD_VAL(TABLE_NAME, 'COD_AMOUNT', XSPECCHG(1,2)) && COD AMOUNT
   
   XSPECVAR(1,6) = GET_FIELD_VAL(TABLE_NAME, 'INSURANCE', XSPECVAR(1,6)) && INSURANCE - .T. = INSURANCE / .F. = NO INSURANCE
